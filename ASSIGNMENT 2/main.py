...
def filter_products(
    ...
    return {"filters": {"min_price": min_price, "max_price": max_price, "category": category},
...
# bulk order models and endpoint 
...
# simple orders endpoint (day1 style) and bonus handlers
@app.post("/orders")
def place_order(order: dict):
    ...
    order["status"] = "pending"  # bonus requirement
    orders.append(order)
